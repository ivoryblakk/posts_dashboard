...
export const EditPostModal = ({ post, dispatch, handleModal, isModalOpen }) => {
  ...
  return post ?
    ...
    >
      ...
      <Modal.Body>
        <p> Title : <textarea className='form-control' type='text' value={titleValue} onChange={e => setTitleValue(e.target.value)} /></p>
        <p> Content : <textarea className='form-control' type='text' value={bodyValue} onChange={e => setBodyValue(e.target.value)} /></p>
      </Modal.Body>
